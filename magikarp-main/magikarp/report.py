...
plt.rcParams["text.usetex"] = False  # Disabled - LaTeX not installed on this system
...
def make_tokens_report(model_id, toka, moda, token_infos, indicator_ix, threshold_ratio, save_hires=False, default_threshold=1.0):
    ...
    for full in [False, True]:  # short and long versions
        ...
        with open(output_name(model_id, "reports" if full else "reports_mini", "md"), "w", encoding="utf-8") as f:
